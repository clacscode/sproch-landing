...
<p>Tres días de conferencias, talleres y networking en el Hotel Marina Las Condes, Santiago.</p>
    ...
    sponsors: [
      { name: "MIS", tier: "platinum" },
      { name: "FGM", tier: "platinum" },
      { name: "P Dental", tier: "gold" },
      { name: "Straumann", tier: "gold" },
      { name: "Kerr", tier: "silver" },
      { name: "Nobel Biocare", tier: "silver" },
      { name: "AlphaBio", tier: "silver" },
      { name: "Dexis", tier: "silver" },
      { name: "Dentaid", tier: "silver" },
      { name: "Corega", tier: "silver" },
      { name: "Hiossen", tier: "bronze" },
      { name: "Punto Dental", tier: "bronze" },
      { name: "Solventum", tier: "bronze" },
      { name: "3Dental", tier: "bronze" },
      { name: "MegaGen Chile", tier: "bronze" },
      { name: "Solara", tier: "bronze" },
    ],
    program: [
      {
